...
let dates_1 = nlp("the second monday of february");
const dates_2 = nlp("I will go next friday");
console.log(dates_1.dates().get());
console.log(dates_2.dates().toShortForm());
